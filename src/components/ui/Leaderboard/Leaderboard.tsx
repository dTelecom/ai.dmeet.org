...
const description = {
  title: "Use AI Voice Agent\nand Get Points",
  text: "We have launched a campaign for early adopters who use the AI Voice Agent during meetings and interactions.",
  rules: {
  ...
  footer: {
    ...
    text2: "We will 💎 reward active campaign participants for their commitment to AI Voice Agent."
  }
};
